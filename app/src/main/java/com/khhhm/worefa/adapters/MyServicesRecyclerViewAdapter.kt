...
import com.khhhm.worefa.CompanyServicesFragment.OnListFragmentInteractionListener
import com.khhhm.worefa.R
import com.khhhm.worefa.adapters.dummy.DummyContent.DummyItem

import kotlinx.android.synthetic.main.fragment_servicesfrahment.view.*
...
class MyServicesRecyclerViewAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_servicesfrahment, parent, false)
